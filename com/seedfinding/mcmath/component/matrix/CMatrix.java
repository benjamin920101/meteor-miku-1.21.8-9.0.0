...
public class CMatrix {
    ...
    public CVector.View getRow(int row) {
        return new CVector.View(this.getColumnCount(), column -> this.get(row, column), (column, value) -> this.set(row, column, value));
    }

    public CVector.View getColumn(int column) {
        return new CVector.View(this.getRowCount(), row -> this.get(row, column), (row, value) -> this.set(row, column, value));
    }
    ...
    public String toString() {
        ...
        CVector.View[] rows = this.getRows();
        for (int i = 0; i < rows.length; ++i) {
    ...
    public static interface Mapper {
        public Complex getNewValue(int var1, int var2, Complex var3);

        default public CVector.Mapper forRow(int row) {
            return (index, oldValue) -> this.getNewValue(row, index, oldValue);
        }

        default public CVector.Mapper forColumn(int column) {
    ...
    public static interface Generator {
        public Complex getValue(int var1, int var2);

        default public CVector.Generator forRow(int row) {
            return index -> this.getValue(row, index);
        }

        default public CVector.Generator forColumn(int column) {
    ...
    extends CMatrix {
        ...
        public static interface Setter {
            public void set(int var1, int var2, Complex var3);
        }
    }
}
