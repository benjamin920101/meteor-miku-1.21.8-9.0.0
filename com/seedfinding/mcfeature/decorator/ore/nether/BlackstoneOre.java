...
public class BlackstoneOre
extends RegularOreDecorator<OreDecorator.Config, OreDecorator.Data<BlackstoneOre>> {
    public static final VersionMap<OreDecorator.Config> CONFIGS = new VersionMap<OreDecorator.Config>().add(MCVersion.v1_16, new OreDecorator.Config(12, 7, 33, 2, HeightProvider.range(5, 10, 37), Blocks.BLACKSTONE, NETHERRACK).add(9, 7, Biomes.CRIMSON_FOREST).add(10, 7, Biomes.WARPED_FOREST)).add(MCVersion.v1_17, new OreDecorator.Config(12, 7, 33, 2, HeightProvider.uniformRange(5, 31), Blocks.BLACKSTONE, NETHERRACK).add(9, 7, Biomes.CRIMSON_FOREST).add(10, 7, Biomes.WARPED_FOREST));
