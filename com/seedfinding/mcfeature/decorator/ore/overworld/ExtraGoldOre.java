...
public class ExtraGoldOre
extends RegularOreDecorator<OreDecorator.Config, OreDecorator.Data<ExtraGoldOre>> {
    public static final VersionMap<OreDecorator.Config> CONFIGS = new VersionMap<OreDecorator.Config>().add(MCVersion.v1_13, new OreDecorator.Config(11, 4, 9, 20, HeightProvider.range(32, 32, 80), Blocks.GOLD_ORE, BASE_STONE_OVERWORLD)).add(MCVersion.v1_16, new OreDecorator.Config(11, 6, 9, 20, HeightProvider.range(32, 32, 80), Blocks.GOLD_ORE, BASE_STONE_OVERWORLD)).add(MCVersion.v1_17, new OreDecorator.Config(14, 6, 9, 20, HeightProvider.uniformRange(32, 79), Blocks.GOLD_ORE, BASE_STONE_OVERWORLD));
