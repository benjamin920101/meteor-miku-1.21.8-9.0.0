...
public class ClayDisk
extends SphereOreDecorator<OreDecorator.Config, OreDecorator.Data<ClayDisk>> {
    public static final VersionMap<OreDecorator.Config> CONFIGS = new VersionMap<OreDecorator.Config>().add(MCVersion.v1_13, new OreDecorator.Config(12, 4, 2, 1, HeightProvider.spreadRange(2, 1), Blocks.CLAY, DIRT_CLAY).add(11, 4, Biomes.SWAMP, Biomes.SWAMP_HILLS)).add(MCVersion.v1_16, new OreDecorator.Config(12, 6, 2, 1, HeightProvider.spreadRange(2, 1), Blocks.CLAY, DIRT_CLAY).add(11, 6, Biomes.SWAMP, Biomes.SWAMP_HILLS)).add(MCVersion.v1_17, new OreDecorator.Config(15, 6, 2, 1, HeightProvider.spreadRange(2, 1), Blocks.CLAY, DIRT_CLAY).add(14, 6, Biomes.SWAMP, Biomes.SWAMP_HILLS));
