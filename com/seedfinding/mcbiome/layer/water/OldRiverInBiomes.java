...
extends IntBiomeLayer {
    ...
    public int sample(int x, int y, int z) {
        ...
        if ((center != Biomes.SWAMP.getId() || this.nextInt(6) != 0) && (center != Biomes.JUNGLE.getId() && center != Biomes.JUNGLE_HILLS.getId() || this.nextInt(8) != 0)) {
            return center;
        }
