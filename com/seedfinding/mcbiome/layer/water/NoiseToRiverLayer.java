...
public class NoiseToRiverLayer
extends CrossLayer {
    ...
    public int sample(int n, int e, int s, int w, int center) {
        ...
        int validCenter = NoiseToRiverLayer.isValidForRiver(center);
        return Biome.applyAll(v -> validCenter == NoiseToRiverLayer.isValidForRiver(v), w, n, e, s) ? -1 : Biomes.RIVER.getId();
    }
